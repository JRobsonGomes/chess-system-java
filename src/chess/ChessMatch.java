...
public class ChessMatch {
	...
	private Piece makeMove(Position source, Position target) {
		...
		/*
		 * Se capturar uma peca, retire da lista de pecas do tabuleiro e adicione na
	...
	/**
	 * Esse metodo retorna um rei com a cor especificada no parametro 1 - Varre as
	 * pecas do tabuleiro filtrando as pecas com a mesma cor especificada no
	 * parametro. 2 - Faz um for na lista de pecas filtradas retornndo somente quem
	 * é instacia de king(rei) 3 - Retorna excecao se nao encontrar nenhum rei
	 * 
	 * @param color
	 * @return
	 */
